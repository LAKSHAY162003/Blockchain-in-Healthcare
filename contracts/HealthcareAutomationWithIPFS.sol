...
contract HealthcareAutomationWithIPFS {
    ...
    function processMedicalData(uint256 oxygenSaturation, uint256 respiratoryRate, uint256 temperature) internal returns (ProcessedMedicalData memory) {
    ...
    function storeMedicalData(string memory _deviceId, uint256 oxygenSaturation, uint256 respiratoryRate, uint256 temperature) public {
        ...
        // Uncomment when we find the correct api url !!
